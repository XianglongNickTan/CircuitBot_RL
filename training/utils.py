...
def show_3d_weightmap_path(analyzer):
...
def add_obstacles(analyzer, top_left, bottom_right):
	""" 1:1 pixel location"""
...
#     objects = []
#
#     object_1 = create_obj(p.GEOM_MESH,
#                                 mass=0.01,
#                                 use_file=obj_cuboid2,
#                                 rgbaColor=[1, 0, 1, 1],
#                                 basePosition=[0.495, 0.075, 0.03],
#                                 baseOrientation=p.getQuaternionFromEuler([0 ,0 ,math.p i /2])
#                                 )
#
#     object_2 = create_obj(p.GEOM_MESH,
#                                 mass=0.01,
#                                 use_file=obj_cuboid2,
#                                 rgbaColor=[1, 0, 1, 1],
...
#                                 )
#
#     object_3 = create_obj(p.GEOM_MESH,
#                                 mass=0.01,
#                                 use_file=obj_cuboid2,
#                                 rgbaColor=[1, 0, 1, 1],
